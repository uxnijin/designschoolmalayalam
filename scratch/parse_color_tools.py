...
section_mapping = {
    "color-inspiration": "Color Inspiration Platforms",
    "color-palette-generators": "Color Palette Generators",
    "color-libraries-systems": "Color Libraries & Systems",
    "colors-in-context": "Colors in Context & Visualizers",
    "gradient-inspiration": "Gradient Inspiration & Editors",
    "color-picker": "Color Pickers & samplers",
    "color-converter": "Color Converters & Formatters",
    "color-contrast-checker": "Color Contrast & Accessibility Checkers",
    "color-books": "Color Books & Literature"
}
...
output_file = "scratch/color_tools_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total color tools parsed: {total}")
