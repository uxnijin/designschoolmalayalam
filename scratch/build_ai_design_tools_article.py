...
# Load parsed AI design tools
with open("scratch/ai_design_tools_by_category.json", "r", encoding="utf-8") as f:
...
print(f"Total cleaned AI design tools: {total_items}")
...
let htmlContent = `
  ...
  <p style="font-size: 1.05rem; margin-bottom: 35px; line-height: 1.85;">
    Here is a curated directory of the best <strong>""" + str(total_items) + """ AI design tools</strong> categorized by function. Use these platforms to augment your creative workflow, build high-fidelity visuals, and automate repetitive tasks.
  </p>
`;
...
ARTICLE_REGISTRY["ai-design-tools"] = {
  ...
  description: "Curated catalog of """ + str(total_items) + """ AI design tools covering image generators, UI mockup platforms, vibe coding, website builders, 3D, animation, and video.",
  date: "2026-06-17",
...
output_file = "article/ai-design-tools.js"
