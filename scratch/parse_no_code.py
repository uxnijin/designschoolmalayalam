...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/687/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "no-code-website-builders": "No-Code Website Builders",
    "web-app-builders": "Web App Builders",
    "mobile-app-builders": "Mobile App Builders",
    "landing-page-builders": "Landing Page & E-commerce Builders",
    "portfolio-builders": "Portfolio Builders",
    "low-code-platforms": "Low-Code Platforms",
    "internal-tools-business-apps": "Internal Tools & Business Apps",
    "notion-to-website": "Notion to Website",
    "design-to-code": "Design-to-Code",
    "visual-editors": "Visual Editors",
    "ui-frameworks-components": "UI Frameworks & Components",
    "automation-tools": "Automation Tools",
    "webflow-resources": "Webflow Resources",
...
output_file = "scratch/no_code_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total no-code website builders parsed: {total}")
