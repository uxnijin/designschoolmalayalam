...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/555/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "design-creative-podcasts": "Design & Creativity Podcasts",
    "product-design-podcasts": "Product Design Podcasts",
    "ux-design-podcasts": "UX Design Podcasts",
    "branding-podcasts": "Branding & Logo Podcasts",
    "graphic-design-podcasts": "Graphic Design Podcasts",
    "web-design-podcasts": "Web Design & Dev Podcasts",
    "motion-design": "Motion Design Podcasts"
}
...
output_file = "scratch/design_podcasts_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total design podcasts parsed: {total}")
