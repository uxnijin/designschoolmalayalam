...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/439/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "ui": "UI Design Inspiration",
    "web": "Web Design Inspiration",
    "vibe-coding": "Vibe Coding & Interactive Inspo",
    "portfolio": "Creative Portfolios",
    "saas": "SaaS & App Layouts",
    "lp": "Landing Pages",
    "mobile": "Mobile UI & App Flows",
    "product-startup": "Product & Startup Design",
    "ecommerce-ad": "E-Commerce & Advertising",
    "email-inspo": "Email Marketing Inspiration",
    "photography": "Photography Inspiration",
    "video": "Video & Motion Inspiration",
    "logo": "Logo & Brand Mark Inspo",
    "branding": "Branding & Identity Showcases",
    "graphic-design": "Graphic Design Inspiration",
    "illustration": "Illustration Inspiration",
    "data-visualization": "Data Visualization & Infographics",
    "inspiration-search-and-organization": "Inspiration Search & Organization Tools"
}
...
output_file = "scratch/inspiration_websites_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total design inspiration websites parsed: {total}")
