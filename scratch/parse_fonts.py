...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/283/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "font-inspiration": "Font Inspiration",
    "free-fonts-libraries": "Free Fonts & Libraries",
    "font-pairings": "Font Pairing & Combinations",
    "pro-fonts-foundries": "Pro Fonts & Foundries",
    "font-editors": "Font Editors",
    "font-managers": "Font Managers",
    "font-finders": "Font Finders",
    "type-scale-calculators": "Type Scale Calculators",
    "experiments-new-fonts": "Experiments & New Fonts",
    "additional-typography-resources": "Additional Typography Resources"
}
...
for i in range(len(section_positions)):
    ...
    for card in cards[1:]:
        ...
        if link_match:
            ...
            if "toools.design" in link and not link.endswith("/tooolsdesigntypography"):
...
output_file = "/Users/nijinmuhammed/Files/Code/design-school-malayalam/scratch/fonts_by_category.json"
