...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/467/content.md"
...
section_mapping = {
    ...
    "guides-tips": "Guides & Reference Sheets",
    "accessibility": "Accessibility Resources",
    "challenges-briefs": "Design Challenges & Briefs",
    "youtube-channels": "YouTube Channels",
    "design-talks": "Design Talks & Conferences"
}
...
output_file = "scratch/learn_design_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total design learning resources parsed: {total}")
