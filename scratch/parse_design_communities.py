...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/495/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "design-communities": "Online Design Communities",
    "design-meetups": "Local Design Meetups",
    "design-conferences-events": "Design Conferences & Events",
    "design-awards": "Design Awards & Showcases",
    "job-boards": "Design Job Boards",
    "professional-networks": "Professional Design Networks"
}
...
output_file = "scratch/design_communities_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total design communities/resources parsed: {total}")
