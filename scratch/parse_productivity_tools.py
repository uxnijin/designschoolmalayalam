...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/587/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "whiteboard-tools": "Whiteboard & Brainstorming Tools",
    "ai-productivity-agents": "AI Productivity Agents",
    "timezone-tools": "Timezone & Scheduling Helpers",
    "video-communication-screen-sharing": "Video & Screen Sharing",
    "screen-recording": "Screen Recording Software",
    "screenshot-tools": "Screenshot & Capture Tools",
    "freelancer-tools": "Freelance Business Management",
    "messaging-collaboration": "Team Messaging & Collaboration",
    "work-platforms": "Workplace Platforms",
    "project-management": "Project Management Suites"
}
...
output_file = "scratch/productivity_tools_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total productivity tools parsed: {total}")
