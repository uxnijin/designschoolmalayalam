...
file_path = "/Users/nijinmuhammed/.gemini/antigravity-ide/brain/597dd776-058f-4914-8acf-a66e9c2f6080/.system_generated/steps/405/content.md"

with open(file_path, "r", encoding="utf-8") as f:
    html = f.read()

section_mapping = {
    "generative-ai": "Generative AI & Image Tools",
    "ui-generation": "UI Generation & Design",
    "vibe-coding": "Vibe Coding & Frontend Builders",
    "ai-website-builders": "AI Website Builders",
    "logo-maker": "AI Logo Makers",
    "branded-content-product-photos": "AI Branded Content & Product Photos",
    "ai-illustration-drawing": "AI Illustration & Drawing",
    "3d-tools": "AI 3D Tools",
    "animation-storytelling": "AI Animation & Storytelling",
    "video-generation": "AI Video Generation",
    "audio-voice-chat": "AI Audio, Voice & Chat",
...
for sec_id in section_mapping.keys():
    # Matches both class="anchor-section" and anchor-section with other classes
...
output_file = "scratch/ai_design_tools_by_category.json"
...
for k, v in categories.items():
    ...
    total += len(v)
print(f"Total AI design tools parsed: {total}")
